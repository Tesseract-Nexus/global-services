...
func (s *Subscriber) Start(ctx context.Context) error {
	...
	orderSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-orders-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
	...
	paymentSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-payments-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	inventorySub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-inventory-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	customerSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-customers-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	returnSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-returns-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	reviewSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-reviews-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	productSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-products-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	categorySub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-categories-v2"),
	...
	ticketSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-tickets-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	staffSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-staff-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	couponSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-coupons-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	vendorSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-vendors-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
	...
	approvalSub, err := js.QueueSubscribe(
		...
		nats.Durable("notification-hub-approvals-v2"),
		nats.DeliverAll(),
		nats.ManualAck(),
		nats.AckWait(30*time.Second),
		nats.MaxDeliver(3),
