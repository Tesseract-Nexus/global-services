...
func (c *Client) ensureStreams() error {
	streams := []nats.StreamConfig{
		...
		{
			Name:        "PRODUCT_EVENTS",
			Description: "Product CRUD events",
		...
		},
		{
			...
			Description: "Category CRUD events",
		...
		{
			Name:        "STAFF_EVENTS",
			Description: "Staff management events",
		...
		{
			Name:        "COUPON_EVENTS",
			Description: "Coupon/discount events",
		...
		{
			Name:        "VENDOR_EVENTS",
			Description: "Vendor management events",
			Subjects:    []string{"vendor.>"},
			Storage:     nats.FileStorage,
			Retention:   nats.LimitsPolicy,
			MaxAge:      24 * time.Hour * 7,
			MaxMsgs:     100000,
